...
#show programs time to run and out put to communicate file
elapsedsime = round((time.time() - start_time), 4)
showElapsedtime = ("Elapsed time: %s sec" % (elapsedsime))
f = open("communicate.txt","w")
f.write(showElapsedtime)
