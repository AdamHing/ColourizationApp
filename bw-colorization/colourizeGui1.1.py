...
class Ui(QtWidgets.QMainWindow, QtCore.QThread):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Adams Colourization GUI')
        ...
        self.button.pressed.connect(self.GoWhenPressed)
        self.button.released.connect(self.GoWhenReleased)
    ...
    def resetInputs(self):
        ...
        self.cpuButton.setStyleSheet("none")
        self.gpuButton.setStyleSheet("none")
        self.button.setStyleSheet("none")

    #open_fileBrower
    def open_fileBrowser(self):
        global setmode, dovideo, doimage, sourcefile
        dovideo = False
        doimage = False
    ...
    def GoWhenPressed(self):
        ...
        print(setmode)
        if setmode == None:
            QMessageBox.about(self, "Warning", "fill in all the stuff")
            
        pythonpath = "python "
        folderlocation = os.path.dirname(os.path.abspath(__file__))
